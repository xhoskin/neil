...
//оборачивание
%                   //перейти к открывающей|закрывающей скобке или тегу
S(                  //обернуть выделение в скобки [SURROUND]
ds(                 //удалить скобки [DELETE SURROUNDINGS]
dst                 //strip tag (снять оболочку с тега)
cs([                //заменить круглые скобки на квадратные [CHANGE SURROUNDINGS]
cst<p>              //заменить тег на <p>
ysw(                //обернуть слово в скобки
yss(                //обернуть текущую строку в скобки
ySS(                //обернуть текущую строку в скобки и выровнять отступы
//метки
